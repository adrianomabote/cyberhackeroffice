      ...
      <footer className="py-8 px-4 border-t-2 border-red-800 bg-black">
        <div className="container mx-auto">
          <div className="text-center mb-6">
            ...
            >
              <button className="bg-green-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 transition-colors animate-heartbeat flex items-center gap-2 mx-auto">
